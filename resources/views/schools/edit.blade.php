...
@section('page-title') Edit Schools @endSection
...
<div class="row">
    <div class="col-12 col-md-8 col-lg-12 container p-2">
        <div class="d-flex justify-content-between  align-items-end mb-3">
            <p class="text-muted p-2">This page is used to edit a schools details in the system.</p>
        ...
        <form action="{{route('schools.update',$school->id)}}" method="post"   enctype="multipart/form-data">
            ...
            <div class="form-group mb-3">
                ...
                <input type="text" class="form-control rounded-0" placeholder="School Name" required value="{{$school->name}}"  name="name">
                @error('name')
            ...
            <div class="form-group mb-3">
                ...
                <input type="email" class="form-control rounded-0" placeholder="School Email"  value="{{$school->email}}"  name="email">
                @error('email')
                <span class="text-danger">{{$message}}</span>
                @endError
            </div>
            <div class="form-group mb-3">
                ...
                <input type="url" class="form-control rounded-0" value="{{$school->website}}"  placeholder="https://myshool.example.co.ug" name="website">
                @error('website')
                <span class="text-danger">{{$message}}</span>
                @endError
            </div>
            ...
            <div class="form-group mb-3">
                ...
                <select name="ownership" id="" class="form-control dorm-select rounded-0">
                    ...
                    <option selected value="{{$school->ownership}}">{{ Str::ucfirst($school->ownership) }}</option>
            ...
            <div class="form-group mb-3">
                ...
                <select name="category_id" id="" class="form-control dorm-select rounded-0">
                    ...
                    @foreach ($categories as $category)
                        <option <?=$category->id == $school->category_id ?'selected' :''  ?>  value="{{$category->id}}">{{$category->name}}</option>
                    @endforeach
            ...
            <div class="row">
                <div class="form-group mb-3 col-md-6 col-xl-6 col-sm-6">
                    ...
                    <input type="text" class="form-control rounded-0" value="{{$phoneNumbers[0]}}"  placeholder="Line 1" name="phone_number[]">
                    @error('phone_number')
                    <span class="text-danger">{{$message}}</span>
                    @endError
                </div>
                ...
                <div class="form-group mb-3 col-md-6 col-xl-6 col-sm-6">
                    ...
                    <input type="text" class="form-control rounded-0" value="{{ $phoneNumbers[1] }}"  placeholder="Line 2" name="phone_number[]">
                    @error('phone_number')
                    <span class="text-danger">{{$message}}</span>
                    @endError
                </div>
            ...
            <div class="form-group mb-3">
                ...
                <input type="text" class="form-control rounded-0"  value="{{$school->address}}"  placeholder="School Address" name="address">
                @error('address')
                <span class="text-danger">{{$message}}</span>
                @endError
            </div>
            ...
            <div class="row">
                <div class="form-group mb-3 col-md-4 col-xl-4 col-sm-4">
                    ...
                    <input type="text" class="form-control rounded-0"   value="{{$school->district}}" placeholder="District" name="district">
                    @error('district')
                    <span class="text-danger">{{$message}}</span>
                    @endError
                </div>
                ...
                <div class="form-group mb-3 col-md-4 col-xl-4 col-sm-4">
                    ...
                    <option value="">Choose ...</option>
                    <option selected value="{{$school->region}}">{{ Str::upper($school->region) }}</option>
                ...
                <div class="form-group mb-3 col-md-4 col-xl-4 col-sm-4">
                    ...
                    <input type="text" class="form-control rounded-0" value="{{ $school->postal_code}}" placeholder="P.O Box" name="postal_code">
                    @error('postal_code')
                    <span class="text-danger">{{$message}}</span>
                    @endError
                </div>
            ...
            <div class="row mb-3">
                <div class="form-group mb-3 col-md-6 col-xl-6 col-sm-6">
                    ...
                    <input type="number" class="form-control rounded-0"  value="{{ $school->latitude}}" placeholder="Latitude" name="latitude">
                    @error('latitude')
                    <span class="text-danger">{{$message}}</span>
                    @endError
                </div>
                ...
                <div class="form-group mb-3 col-md-6 col-xl-6 col-sm-6">
                    ...
                    <input type="text" class="form-control rounded-0" value="{{ $school->longitude}}" placeholder="Longitude" name="longitude">
                    @error('longitude')
                    <span class="text-danger">{{$message}}</span>
                    @endError
                </div>
            ...
            <div class="row mb-3 justify-content-between align-items-start">
                ...
                <img src="/storage/{{$school->barge_image}}" class="img"  width="250"/>
                </div>
            </div>
            ...
            <div class="row mb-3 justify-content-between align-items-start">
                ...
                <img src="/storage/{{$school->main_banner}}" class="img"  width="100%" />
                </div>
            </div>
            <div class="row mb-3 justify-content-between align-items-start">
                <div class="form-group col-md-4 col-xl-4">
                ...
                <img src="/storage/{{$school->secondary_banner}}" class="img"  width="100%" >
                </div>
            </div>

            <div class="form-group mb-3 col-md-4 col-xl-4 col-sm-4">
                    <label for="postal">Year Started</label>
                    <input type="number" class="form-control rounded-0"  value="{{$school->year_started}}" placeholder="1944" name="year_started">
                    @error('year_started')
                    <span class="text-danger">{{$message}}</span>
                    @endError
            </div>
            <div class="form-group mb-3">
                ...
                <option selected value="{{$school->religious_affiliation}}">{{ Str::upper($school->religious_affiliation) }}</option>
            ...
            <div class="form-group mb-3">
                ...
                <textarea name="mission" class="form-control rounded-0" id="" cols="30" rows="4">{{ $school->mission}}</textarea>
                @error('mission')
                     <span class="text-danger">{{$message}}</span>
                @endError
            </div>
            <div class="form-group mb-3">
                ...
                <textarea name="vision" class="form-control rounded-0" id="" cols="30" rows="4">{{ $school->vision}}</textarea>
                @error('vision')
                     <span class="text-danger">{{$message}}</span>
                @endError
            </div>
            ...
            <div class="form-group mb-3">
                ...
                <textarea name="background" class="form-control rounded-0" id="" cols="30" rows="10">{{ $school->background}}</textarea>
                @error('Background')
                     <span class="text-danger">{{$message}}</span>
                @endError
            </div>
